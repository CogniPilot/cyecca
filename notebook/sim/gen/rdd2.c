...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[0]=(w[0]*w[4]);
  w[9]=arg[1]? arg[1][2] : 0;
  w[13]=arg[4]? arg[4][2] : 0;
  w[10]=arg[7]? arg[7][2] : 0;
  w[14]=(w[4]*w[5]);
  w[10]=(w[10]+w[14]);
  w[14]=(w[13]<w[10]);
  w[15]=(w[14]?w[13]:0);
  ...
  if (res[1]!=0) res[1][1]=w[12];
  if (res[1]!=0) res[1][2]=w[15];
  if (res[2]!=0) res[2][0]=w[1];
  if (res[2]!=0) res[2][1]=w[2];
  if (res[2]!=0) res[2][2]=w[4];
  if (res[3]!=0) res[3][0]=w[6];
  if (res[3]!=0) res[3][1]=w[11];
  if (res[3]!=0) res[3][2]=w[14];
...
static int casadi_f2(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[11]=casadi_sq(w[10]);
  w[9]=(w[9]-w[11]);
  w[12]=arg[7]? arg[7][3] : 0;
  w[13]=casadi_sq(w[12]);
  w[9]=(w[9]-w[13]);
  w[14]=arg[6]? arg[6][0] : 0;
  w[9]=(w[9]*w[14]);
  w[15]=(w[7]*w[10]);
  w[16]=(w[5]*w[12]);
  w[17]=(w[15]-w[16]);
  ...
  w[20]=casadi_sq(w[9]);
  w[3]=(w[3]+w[20]);
  w[20]=arg[3]? arg[3][2] : 0;
  w[1]=(w[1]*w[20]);
  w[20]=arg[5]? arg[5][2] : 0;
  w[15]=arg[1]? arg[1][2] : 0;
  w[20]=(w[20]-w[15]);
  w[17]=(w[17]-w[19]);
  w[17]=(w[4]*w[17]);
  w[17]=(w[17]*w[14]);
  ...
  w[17]=(w[17]+w[9]);
  w[9]=arg[4]? arg[4][1] : 0;
  w[13]=arg[4]? arg[4][3] : 0;
  w[10]=(w[9]*w[13]);
  w[18]=arg[4]? arg[4][0] : 0;
  w[5]=arg[4]? arg[4][2] : 0;
  w[14]=(w[18]*w[5]);
  w[19]=(w[10]-w[14]);
  w[19]=(w[4]*w[19]);
  ...
  w[10]=(w[10]+w[14]);
  w[10]=(w[4]*w[10]);
  w[14]=atan2(w[12],w[10]);
  w[14]=(w[7]?w[14]:0);
  w[7]=(!w[7]);
  w[19]=(w[19]+w[15]);
  w[19]=casadi_fabs(w[19]);
  w[19]=(w[19]<w[0]);
  w[12]=(-w[12]);
  w[10]=(-w[10]);
  w[12]=atan2(w[12],w[10]);
  w[12]=(w[19]?w[12]:0);
  w[19]=(!w[19]);
  w[10]=(w[9]*w[5]);
  w[15]=(w[18]*w[13]);
  ...
  w[10]=(w[10]?w[15]:0);
  w[18]=(w[18]+w[10]);
  if (res[1]!=0) res[1][3]=w[18];
  w[18]=arg[9]? arg[9][0] : 0;
  w[20]=(w[20]*w[18]);
  w[1]=(w[1]-w[20]);
  w[20]=(w[21]<w[1]);
  w[20]=(!w[20]);
...
static int casadi_f6(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  w[5]=(w[0]/w[7]);
  w[21]=(w[4]*w[5]);
  w[17]=casadi_fabs(w[4]);
  w[2]=casadi_fabs(w[14]);
  w[17]=casadi_fmax(w[17],w[2]);
  w[2]=casadi_fabs(w[19]);
  w[17]=casadi_fmax(w[17],w[2]);
  w[2]=casadi_fabs(w[1]);
  w[17]=casadi_fmax(w[17],w[2]);
  w[21]=(w[21]/w[17]);
