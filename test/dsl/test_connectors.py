...
class TestConnectorDecorator:
    ...
    def test_connector_with_parameters(self) -> None:
        ...
        class ParameterizedPin:
            ...
            v = var()
            i = var(flow=True)
            R_internal = var(0.01, parameter=True)  # Parameters don't affect balance
    ...
    def test_connector_no_equations(self) -> None:
        ...
        from cyecca.dsl import connector, equations, var
    ...
    def test_connector_no_algorithm(self) -> None:
        ...
        from cyecca.dsl import algorithm, connector, var
    ...
    def test_connector_no_submodels(self) -> None:
        ...
        from cyecca.dsl import connector, model, submodel, var
    ...
    def test_connector_array_balancing(self) -> None:
        ...
        class VectorPin:
            ...
            x = var(shape=(3,))  # 3 potential variables
            f = var(shape=(3,), flow=True)  # 3 flow variables
    ...
    def test_connector_array_imbalance(self) -> None:
        ...
        with pytest.raises(TypeError, match="balancing violation"):
            ...
            @connector
            class BadVectorPin:
                x = var(shape=(3,))  # 3 potential
                f = var(shape=(2,), flow=True)  # Only 2 flow
...
class TestConnectFunction:
    ...
    def test_connect_outside_equations_raises(self) -> None:
        ...
        from cyecca.dsl import connect, connector, model, submodel, var
    ...
    def test_connect_non_connector_raises(self) -> None:
        ...
        from cyecca.dsl import connect, equations, model, submodel, var
    ...
    def test_connect_mismatched_connectors_raises(self) -> None:
        ...
        @connector
        class OtherPin:
            voltage = var()  # Different name!
            current = var(flow=True)
