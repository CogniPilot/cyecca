...
class TestRelationalOperators:
    ...
    def test_chained_relational(self) -> None:
        ...
        from cyecca.dsl import model, var, der, and_, ExprKind
...
class TestBooleanOperators:
    ...
    def test_or_operator(self) -> None:
        ...
        from cyecca.dsl import model, var, der, or_, ExprKind
    ...
    def test_not_operator(self) -> None:
        ...
        from cyecca.dsl import model, var, der, not_, ExprKind
    ...
    def test_nested_boolean_operators(self) -> None:
        ...
        from cyecca.dsl import model, var, der, and_, or_, not_, ExprKind
    ...
    def test_boolean_with_constants(self) -> None:
        ...
        from cyecca.dsl import model, var, der, and_, or_, ExprKind
...
class TestIfThenElse:
    ...
    def test_basic_if_then_else(self) -> None:
        ...
        from cyecca.dsl import model, var, der, if_then_else, ExprKind
    ...
    def test_if_then_else_with_boolean_condition(self) -> None:
        ...
        from cyecca.dsl import model, var, der, if_then_else, and_, ExprKind
...
class TestAlgorithmSection:
    ...
    def test_basic_algorithm_assignment(self) -> None:
        ...
        from cyecca.dsl import model, var, Assignment
    ...
    def test_algorithm_with_local_variable(self) -> None:
        ...
        from cyecca.dsl import model, var, local, Assignment
    ...
    def test_algorithm_with_if_then_else(self) -> None:
        ...
        from cyecca.dsl import model, var, local, if_then_else
    ...
    def test_algorithm_multiple_locals(self) -> None:
        ...
        from cyecca.dsl import model, var, local
    ...
    def test_assign_function(self) -> None:
        ...
        from cyecca.dsl import model, var, assign, Assignment
    ...
    def test_algorithm_local_arithmetic(self) -> None:
        ...
        from cyecca.dsl import model, var, local, ExprKind
...
class TestCasadiBackendNewFeatures:
    ...
    def test_compile_boolean_operators(self) -> None:
        ...
        from cyecca.dsl import model, var, der, and_, or_, not_
        from cyecca.dsl.backends import CasadiBackend
